#!/usr/bin/env python3
"""
Restaurant Enrichment Script (Streaming Version)
...
Usage:
    ...
    # With checkpointing every 100 rows (resumable)
    python enrich_restaurants_streaming.py --api-key YOUR_KEY --input resy_gda_usa.csv --checkpoint 100
...
def enrich_restaurants_streaming(
    ...
    """
    Stream-process restaurants with optional checkpointing.
...
def main():
    parser = argparse.ArgumentParser(
        description="Enrich restaurant data with Google Places API (streaming version)",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
    # Basic streaming enrichment
    python enrich_restaurants_streaming.py --api-key YOUR_KEY --input resy_gda_usa.csv
    
    # With checkpointing every 500 rows (can resume if interrupted)
    python enrich_restaurants_streaming.py --api-key YOUR_KEY --input resy_gda_usa.csv --checkpoint 500
    
    # Resume from last checkpoint after interruption
    python enrich_restaurants_streaming.py --api-key YOUR_KEY --input resy_gda_usa.csv --resume
    
    # Test with first 100 rows
    python enrich_restaurants_streaming.py --api-key YOUR_KEY --input resy_gda_usa.csv --limit 100
    
    # Process specific state (filter externally first)
    grep ",NY," resy_gda_usa.csv > resy_ny.csv
    python enrich_restaurants_streaming.py --api-key YOUR_KEY --input resy_ny.csv
